...
namespace DesktopAppAuto.Config
{
    [Extension]
    public class ReportPortalCustomization : NUnit.Engine.ITestEventListener
    {
        public ReportPortalCustomization()
        {
        ...
        private void ReportPortalListener_AfterTestStarted(object sender, ReportPortal.NUnitExtension.EventArguments.TestItemStartedEventArgs e)
        {
            e.TestReporter.Log(new CreateLogItemRequest
            {
                ...
                Text = "Launch Desktop Application Demo"
            });
